...
from kernel_plotter import plot_kerns
'''
...
# defining kx,ky grid for a cube of 401 pixels in X and Yd
# distance between adjacent pixels - 0.972 Mm
k_grid = np.fft.fftshift(np.fft.fftfreq(401,0.972*1e6))*2*np.pi

k_grid = k_grid[140:261]
...
plot_kerns.plot_LorentzKern_z(z, Lorentz_kern)
